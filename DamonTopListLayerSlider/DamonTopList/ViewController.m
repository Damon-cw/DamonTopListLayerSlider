...
//    self.pages = @[[self testVC1], [self testVC2], [self testVC3], [self testVC4], [self testVC5]];
    self.pagesContainer.topScrollView.itemLayoutStyle = ItemLayoutStyleUseWidth;
//    self.pagesContainer.
...
- (TestViewController *)testVC3
{
    if (!_testVC3) {
        ...
        testVC3.view.height = SCREENHEIGHT - 64;
...
- (TestViewController *)testVC4
{
    if (!_testVC4) {
        ...
        testVC4.view.height = SCREENHEIGHT - 64;
...
- (TestViewController *)testVC5
{
    if (!_testVC5) {
        ...
        testVC5.view.height = SCREENHEIGHT - 64;
...
- (TestViewController *)testVC6
{
    if (!_testVC6) {
        ...
        testVC6.view.height = SCREENHEIGHT - 64;
...
- (TestViewController *)testVC7
{
    if (!_testVC7) {
        ...
        testVC7.view.height = SCREENHEIGHT - 64;
...
- (TestViewController *)testVC8
{
    if (!_testVC8) {
        ...
        testVC8.view.height = SCREENHEIGHT - 64;
...
- (TestViewController *)testVC9
{
    if (!_testVC9) {
        ...
        testVC9.view.height = SCREENHEIGHT - 64;
